...
<template>
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="products">
      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
        ...
        <div class="flex flex-wrap-reverse items-center data-list-btn-container">
          ...
          <div class="btn-add-new p-3 mb-4 mr-4 rounded-lg cursor-pointer flex items-center justify-center text-lg font-medium text-base text-primary border border-solid border-primary" @click="addNewData">
              ...
              <span class="ml-2 text-base text-primary">Sale Form</span>
          </div>
        </div>
      ...
      <template slot="thead">
        <vs-th sort-key="name">Coustomer</vs-th>
        <vs-th sort-key="category">Category</vs-th>
        <vs-th sort-key="popularity">Issue Date</vs-th>
        <vs-th sort-key="order_status">Due Date </vs-th>
        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
              <p class="product-issu">{{ tr.issud }}</p>
              </vs-td>

              <vs-td>
              <p class="product-issu">{{ tr.dued }}</p>
...
export default {
  ...
  methods: {
    addNewData() {
     window.location.href = '/dashboard/sale-gstform'
    },
    deleteData(id) {
