    ...
    <div class="vx-card p-6" style="" >
     ...
     <tr>
      <td width="25%">
       ...
       <td width="50%"><center><h1>Production Card<br><h4><font color="blue">View</font></h4></h1></center></td>
       <td width="25%"  align="right">Today 28-02-2020 <br> Friday
...
<table border="0" width="100%" cellspacing="5"  class="tables">
    <tr>
          ...
          <td class="overlap"> 
            ...
            <option value="">Auto Selection one by</option>
          </select>
          </td>
        </tr>
</table>
